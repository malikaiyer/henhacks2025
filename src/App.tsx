        ...
        <Navbar bg="light" fixed="top" expand="lg" className="p-3">
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ml-auto">
              ...
              <Nav.Link as={Link} to="/about">What is Food Insecurity?</Nav.Link>
              <Nav.Link as={Link} to="/services">Statistics on Food Insecurity</Nav.Link>
        ...
        <Routes>
          ...
          <Route path="/" element={
            <div style={{ textAlign: 'center', paddingTop: '100px' }}>
              <h2>Welcome to RescueBites</h2>
              <p>Tackling food insecurity one bite at a time</p>
            </div>
          } />
        </Routes>
